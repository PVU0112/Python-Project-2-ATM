        ...
        with open("data.csv", mode="r", newline="") as file:
            ...
            for row in reader:
                if len(row) >= 3 and row[0] == first_name and row[1] == last_name and row[2] == pin:
                    ...
                    gui.radio_button.pack(anchor='w', padx=10, pady=10, after=gui.to_do)
                    gui.money_amount.pack(anchor='w', padx=10, pady=10, after=gui.radio_button)
                    ...
                    gui.entry_exit.pack(anchor='w', padx=10, pady=10, after=gui.money_amount)
...
def enter_click(gui: object, amount: str, bank_action: str, balance: float, first_name: str, last_name: str,
    ...
    if not gui.money_decision.get():
        gui.total_amount.pack(anchor='w', padx=10, pady=10, after=gui.entry_exit)
...
def restart(gui:object) -> None:
    ...
    '''
    gui.first_name.pack(anchor='w', padx=10, pady=10, before=gui.welcome)
    gui.last_name.pack(anchor='w', padx=10, pady=10, after=gui.first_name)
    gui.pin_number.pack(anchor='w', padx=10, pady=10, after=gui.last_name)
    gui.search_create_button.pack(anchor='w', padx=10, pady=10, after=gui.pin_number)
